...
{
    public class LevelWindowTool : EditorWindow
    {
        Vector2 scrollpos; // 
        ...
        {
            GetWindow<LevelWindowTool>("Level Window");
        }
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("LevelConfig"))
            {
                ...
                if (levelconfigs.Count < noofLevel)
                {
                    ...
                    {
                        levelconfigs.Add(new LevelConfigSO { LevelNumber = levelconfigs.Count + 1 });
                    }
                }
            }
        ...
        private void LoadConfiguration()
        {
            ...
            {
                LevelConfigSO levelConfig = AssetDatabase.LoadAssetAtPath<LevelConfigSO>(assetPath);
                if (levelConfig != null)
                {
